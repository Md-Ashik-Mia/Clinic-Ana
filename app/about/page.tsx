      ...
      <div className="mt-12 space-y-20">
        {isLoading ? (
          ...
          (sections ?? []).map((section) => {
            ...
            const highlight = (language === 'es' ? section.highlight_es : null) || section.highlight || section.highlight_es || '';
            const description = (language === 'es' ? section.description_es : null) || section.description || section.description_es || '';
            const imageAlt = (language === 'es' ? section.image_alt_es : null) || section.image_alt || section.image_alt_es || '';
