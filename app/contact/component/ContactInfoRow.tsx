...
function InfoCard({
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <div className="mt-3 text-[18px] font-semibold text-[#003B33]">
        {title}
      </div>
      <div className="mt-2 space-y-1 text-[14px] leading-tight text-[#525252]">
        {children}
      </div>
    </div>
  );
      ...
      <div className="page-container">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 py-8">
          ...
          <InfoCard
            ...
            title={t("contact.info.workingDayTitle")}
          >
            {topHours.length ? (
              topHours.map((h) => (
                <div key={String(h.id)}>
