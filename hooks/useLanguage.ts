...
const translations: Record<Language, Record<TranslationKey, string>> = {
	en: {
		...
		"team.description": "Our team consists of two physiotherapists and a podiatrist, all trained and experienced in various areas of rehabilitation and pain management, as well as in analyzing biomechanical issues that may affect your body.",
		...
		"home.whyChooseUs.descriptionLine1": "With a patient-centered approach and evidence-based therapies, we provide the care you need.",
		"home.whyChooseUs.descriptionLine2": "From precise assessments to ongoing support, we guide you through every step of your recovery process.",
		"home.whyChooseUs.features.expertTherapists.title": "Expert Therapists",
		"home.whyChooseUs.features.expertTherapists.description": "Certified and trained physiotherapists, dedicated to providing accurate diagnoses and tailored treatments.",
		"home.whyChooseUs.features.personalizedCare.title": "Personalized Care",
		"home.whyChooseUs.features.personalizedCare.description": "Each treatment plan is tailored to your condition, goals, and lifestyle, ensuring optimal recovery.",
		"home.whyChooseUs.features.modernTechniques.title": "Modern Techniques",
		"home.whyChooseUs.features.modernTechniques.description": "We use modern, up-to-date techniques to achieve the best results.",
		"home.whyChooseUs.features.friendlyEnvironment.title": "Warm Environment",
		"home.whyChooseUs.features.friendlyEnvironment.description": "A calm and welcoming space where your well-being and comfort are our top priority.",
		...
		"home.specializedTreatments.descriptionLine1": "We offer advanced therapies tailored to each patient’s needs.",
		"home.specializedTreatments.descriptionLine2": "Our goal is to identify the root cause of the symptoms.",

		"home.testimonialsPreview.title": "Testimonial",
		"home.testimonialsPreview.descriptionLine1": "Our patients share how personalized treatments and dedicated support have helped them improve.",
		"home.testimonialsPreview.descriptionLine2": "Their experiences reflect our commitment to their well-being.",
	...
	es: {
		...
		"team.description": "Nuestro equipo está compuesto por dos fisioterapeutas y una podóloga, todas formadas y con experiencia en diversas áreas de la rehabilitación y el manejo del dolor, así como en el estudio de problemas biomecánicos que pueden afectar tu cuerpo.",
		...
		"home.whyChooseUs.descriptionLine1": "Con un enfoque centrado en el paciente y terapias basadas en la evidencia, ofrecemos la atención que necesitas.",
		"home.whyChooseUs.descriptionLine2": "Desde una evaluación precisa hasta un acompañamiento continuo, te guiamos en cada paso de tu proceso de recuperación.",
		"home.whyChooseUs.features.expertTherapists.title": "Terapeutas expertos",
		"home.whyChooseUs.features.expertTherapists.description": "Fisioterapeutas certificados y capacitados, comprometidos en ofrecer diagnósticos precisos y tratamientos personalizados.",
		"home.whyChooseUs.features.personalizedCare.title": "Atención personalizada",
		"home.whyChooseUs.features.personalizedCare.description": "Cada plan de tratamiento se adapta a tu condición, objetivos y estilo de vida, asegurando una recuperación óptima.",
		"home.whyChooseUs.features.modernTechniques.title": "Técnicas modernas",
		"home.whyChooseUs.features.modernTechniques.description": "Aplicamos técnicas modernas y actualizadas para lograr los mejores resultados.",
		"home.whyChooseUs.features.friendlyEnvironment.title": "Ambiente cálido",
		"home.whyChooseUs.features.friendlyEnvironment.description": "Un espacio tranquilo y acogedor, donde tu bienestar y comodidad son nuestra máxima prioridad.",
		...
		"home.specializedTreatments.descriptionLine1": "Ofrecemos terapias avanzadas adaptadas a las necesidades de cada paciente.",
		"home.specializedTreatments.descriptionLine2": "Nuestro objetivo es buscar el origen de la sintomatología.",

		"home.testimonialsPreview.title": "Testimonios",
		"home.testimonialsPreview.descriptionLine1": "Nuestros pacientes comparten cómo los tratamientos personalizados y el apoyo constante les han ayudado a mejorar.",
		"home.testimonialsPreview.descriptionLine2": "Sus experiencias respaldan nuestro compromiso con su bienestar.",
